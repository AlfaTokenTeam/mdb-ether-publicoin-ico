...
import "./MDBEtherPublicoin.sol";

contract MDBEtherPublicoinPreSale {
    MDBEtherPublicoin public token;
    ...
    function MDBEtherPublicoinPreSale(
        MDBEtherPublicoin _token,
        address _beneficiary,
        address _alfatokenteam
    ) {
        token = MDBEtherPublicoin(_token);
